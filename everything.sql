...
CREATE TABLE petowners ( PetID INT, OwnerID INT, PRIMARY KEY (PetID, OwnerID) );

CREATE TABLE petowners ( PetID INT, OwnerID INT, Ownership INT AUTO_INCREMENT, PRIMARY KEY (Ownership) );
...
INSERT INTO petowners(PetID, OwnerID) ( SELECT id, owner_id from pet );
